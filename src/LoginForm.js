...
//   }
//   render() {
//     const { count, signupMode } = this.state;
...
//     return (
//       <div className={signupMode} style={{
//         fontSize: 20,
//         background: "blue",
//         position: "absolute"
//       }}>
...
export default () => {
  ...
  const signUpButtonClick = () => {
    console.log("add sign-up-mode class to .container")
  }

  const socialPlatforms = ["fa-facebook-f", "fa-twitter", "fa-google", "fa-linkedin"]
      ...
      <div className="signin-signup">
        <form action="#" className="sign-in-form">
          ...
          <div className="input-field">
            ...
            <input type="text" placeholder="Username" onInput={usernameInput}/>
          </div>
          <div className="input-field">
    ...
    <div className="panels-container">
      <div className="panel left-panel">
        <div className="content">
          ...
          <button onClick={signUpButtonClick} className="btn transparent" id="sign-up-btn">
            Sign up
          </button>
        </div>
